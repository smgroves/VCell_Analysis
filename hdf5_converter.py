...
def convert_hdf5_to_csv(file_name, dir_path = '', model_name = "", simulation_name = "", species_list = []):
    if len(species_list) == 0:
        default_species = ["Bub1a",'Bub1a_his','CPCa','CPCi','H2A','H3','Haspina', 'Haspini', "Knl1", 'Mps1a',
                            'Mps1i', 'Ndc80', 'Ndc80_Mps1a', 'Ndc80_Mps1i', 'Ndc80_pMps1a', 'Ndc80_pMps1i', 'pH2A',
                            'pH2A_Sgo1', 'pH2A_Sgo1_CPCa', 'pH2A_Sgo1_CPCi', 'pH2A_Sgo1_pH3_CPCa', 'pH2A_Sgo1_pH3_CPCi',
                            'pH3', 'pH3_CPCa', 'pH3_CPCi', 'pKnl1', 'pKnl1_Bub1a', 'Plk1a', 'Plk1i', 'pMps1a',
                            'pMps1i', 'pNdc80', 'pNdc80_Mps1a', 'pNdc80_Mps1i', 'pNdc80_pMps1a', 'pNdc80_pMps1i', 'Sgo1'
                           ]
