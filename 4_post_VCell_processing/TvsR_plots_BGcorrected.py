    ...
    if active == 'all':
        ...
        for i in range(0, len(plot_list), 2):            
            ...
            #Change legend labels here following simulation order:
                ...
                L.get_texts()[1].set_text('Tensed KT')
                ...
                print("saving fig")
                print(tag)
                plt.savefig(f"/Users/catalinaalvarez/Documents/CPC_plots_2026/figures/lineplot_across_sims/{name_plot}_{tag}%_ic_corrected_500s.pdf")
            tag = tag + 5
            plt.show()
            plt.close()
