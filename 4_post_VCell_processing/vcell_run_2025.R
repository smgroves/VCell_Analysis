...
bound_CPC <- c("bound_CPC_FUNCTION")
bound_active_CPC <- c("bound_active_CPC_FUNCTION")
# boundactive_CPC_pNDC80 <- c("boundactive_CPC_pNDC80_FUNCTION")
...
all_species <- c(CPC_species, pNDC80_species)#, pH3_species, pH2A_species, HASPIN_PLK1_species, BUB1a_pKNL1_species, SGO1_species, bound_CPC, bound_active_CPC)
...
# Change
sims <- c(
  "SimID_304798454_0__exported"
)

# Folder naming corresponding to specific simulation ID
# Change
var <- c(
  "02_19_26 CPC_metacentric_relaxed_MCF10A_chr19_PMP1_nopH3Ser10"
)
#########################################################
